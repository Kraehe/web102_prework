...
const unfundedText = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. 
Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? '' : 's'} remain${numUnfundedGames === 1 ? 's' : ''} unfunded. 
We need your help to fund these amazing ${numUnfundedGames === 1 ? 'project' : 'projects'}!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedElement = document.createElement("p");
unfundedElement.textContent = unfundedText;
